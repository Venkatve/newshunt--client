...
function LandingPage() {
  ...
  const login = async () => {
    ...
    try {
      ...
      const result = await axios.post("https://news-hunt-app.herokuapp.com/api/users/login", payload);
  ...
  const register = async () => {
    ...
    try {
      ...
      await axios.post("https://news-hunt-app.herokuapp.com/api/users/register", payload);
    ...
    <div className="h-screen flex items-center sm:flex-col">
      ...
      <div className={`w-1/2 px-10 space-y-5 sm:w-screen ${(showLoginForm || showRegisterForm) && 'sm:hidden'}`}>
        <h1>
          ...
          <b className="text-[#2B8F74] text-8xl">HUNT</b>{" "}
          ...
          <div className="ml-40 sm:ml-0">
            <div className="flex flex-col bg-primary h-screen justify-center items-center px-20 space-y-5">
              ...
              <div className="flex justify-end w-full">
                ...
                <div>Username : demo1234@gmail.com |<span> Password : Demo1234!</span></div>
              </div>
            </div>
          </div>
        )}
